...
#define main_menu_sound PlaySound(0,0,0); PlaySound(TEXT("resourse\\Tetris_Main_Menu_Theme.wav"),NULL,SND_ASYNC|SND_LOOP|SND_FILENAME)
#define in_game_sound PlaySound(0,0,0); PlaySound(TEXT("resourse\\Tetris.wav"),NULL,SND_ASYNC|SND_LOOP|SND_FILENAME)
#define game_over_sound PlaySound(0,0,0); PlaySound(TEXT("resourse\\game_over.wav"),NULL,SND_ASYNC|SND_LOOP|SND_FILENAME)
